...
function Home(){
    ...
    return(
        <div className="home">
            ...
            <p>Hello {member.first_name}, <br/><br/>Dive into a world of boundless knowledge and endless stories with our extensive collection of digital books. Whether you’re a student, a casual reader, or a literary enthusiast, Rumi Online Library is your gateway to an enriching reading experience. Explore thousands of titles across various genres and subjects, all at your fingertips.<br/><br/> Join our community of book lovers and embark on your next literary adventure today!</p>
         </div>
    )
